...
namespace HangmanAppTest
{
    internal class Program
    {
        ...
        //function which print the word above the dashed lines
        private static int printWord(List<char> guessedLetters, String randomWord) 
        {
            int counter = 0; // to iterate through the random word
            int rightLetters = 0; //numbers of letters in the word that the user has guessed correctly
            Console.WriteLine();
        ...
        //print the lines below the words
        private static void printLines(String randomWord)
        {
            ...
            foreach (char c in randomWord)
            {
                ...
                Console.Write("\u0305 ");  //print overlying character right below the letters
            }
        }
